...
final middleCombosProvider =
  ...
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$middleCombosHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
/// See also [NumberList].
@ProviderFor(NumberList)
final numberListProvider =
    AutoDisposeNotifierProvider<NumberList, List<int>>.internal(
  NumberList.new,
  name: r'numberListProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$numberListHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _$NumberList = AutoDisposeNotifier<List<int>>;
